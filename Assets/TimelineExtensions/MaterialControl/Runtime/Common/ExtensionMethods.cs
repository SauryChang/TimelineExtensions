...
namespace MaterialTrack
{
    public static class ExtensionMethods
    {
        ...
        public static void SetTextureOffset(this MaterialPropertyBlock block, string name, Vector2 value)
            => block.SetTextureScaleOffset(name, new Vector4(1, 1, value.x, value.y));
#if NET_80
        public static Color TextureDefaultNameToColor(this string name) => name.ToLowerInvariant() switch
        {
            "black" => Color.black,
            "grey" => Color.grey,
